  ...
  return (
    <div className="w-screen bg-blue">
      ...
      <div className="flex justify-center p-8">
        <div className="flex flex-col sm:flex-row items-center gap-8 w-full py-16 bg-secondary lg:w-[85%] mx-auto">
          <Image
            src={"/assets/home/observing_plant.jpg"}
            alt={"Leadership Image"}
            height={1000}
            width={1000}
            className="w-full sm:w-auto sm:h-80 aspect-square object-cover rounded-lg"
          />
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 w-full gap-4">
            {Array.from({ length: 5 }).map((a, i) => (
              <div key={i} className="flex flex-col items-center gap-4">
                ...
                <div className="max-w-xs mx-auto rounded-lg overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300">
                  <Image
                    src={"/assets/home/observing_plant.jpg"}
                  ...
                  <div className="px-4 pb-4 space-y-2 bg-white">
                    ...
                    <p className="text-sm">27 February, 2025</p>
                  </div>
                </div>
                {/* </RippleEffect> */}
              </div>
